    ...
    public partial class CreateDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 2, 23, 1, 34, 35, 422, DateTimeKind.Local).AddTicks(4016), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 23, 1, 34, 35, 399, DateTimeKind.Local).AddTicks(8870), "Stock Receipt" },
                    { 2, new DateTime(2023, 2, 23, 1, 34, 35, 408, DateTimeKind.Local).AddTicks(9494), "Stock Out" },
                    { 3, new DateTime(2023, 2, 23, 1, 34, 35, 408, DateTimeKind.Local).AddTicks(9525), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7285), "pc", "Piece" },
                    { 2, new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7592), "kg", "Kilogram" },
                    { 3, new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7606), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2023, 2, 23, 1, 34, 35, 421, DateTimeKind.Local).AddTicks(8732), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2023, 2, 23, 1, 34, 35, 422, DateTimeKind.Local).AddTicks(9763), null, null, 1m, "Example Product", 1 });
