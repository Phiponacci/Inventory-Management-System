...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20230223003436_CreateDb")]
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 422, DateTimeKind.Local).AddTicks(9763),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 422, DateTimeKind.Local).AddTicks(4016),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 399, DateTimeKind.Local).AddTicks(8870),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 408, DateTimeKind.Local).AddTicks(9494),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 408, DateTimeKind.Local).AddTicks(9525),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7285),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7592),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 411, DateTimeKind.Local).AddTicks(7606),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 2, 23, 1, 34, 35, 421, DateTimeKind.Local).AddTicks(8732),
